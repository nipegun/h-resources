...
# ----------
# Script de NiPeGun para crear un contenedor de systemd de Parrot Security dentro de Debian
#
# Ejecución remota (puede requerir permisos sudo):
#   curl -sLk https://raw.githubusercontent.com/nipegun/h-resources/refs/heads/main/SystemdSandbox/SystemdSandbox-ParrotSecurity-Crear.sh -o /tmp/sb.sh && chmod +x /tmp/sb.sh && sudo /tmp/sb.sh [CarpetaAMontar]
#
# Ejecución remota como root (para sistemas sin sudo):
#   curl -sLk https://raw.githubusercontent.com/nipegun/h-resources/refs/heads/main/SystemdSandbox/SystemdSandbox-ParrotSecurity-Crear.sh -o /tmp/sb.sh && chmod +x /tmp/sb.sh && sed -i 's-sudo--g' /tmp/sb.sh && /tmp/sb.sh [CarpetaAMontar]
#
# Ejecución remota como root (para sistemas sin sudo) (modificando la carpeta donde crear el sandbox):
#   curl -sLk https://raw.githubusercontent.com/nipegun/h-resources/refs/heads/main/SystemdSandbox/SystemdSandbox-ParrotSecurity-Crear.sh -o /tmp/sb.sh && chmod +x /tmp/sb.sh && sed -i 's-$HOME-/mnt/PartLocalBTRFS-g' /tmp/sb.sh  && sed -i 's-sudo--g' /tmp/sb.sh && /tmp/sb.sh  [CarpetaAMontar]
#
# Bajar y editar directamente el archivo en nano
#   curl -sL https://raw.githubusercontent.com/nipegun/h-resources/refs/heads/main/SystemdSandbox/SystemdSandbox-ParrotSecurity-Crear.sh | nano -
# ----------
...
# Variables
  ...
  vMirrorParrotSecurity="http://deb.ParrotSecurity.org/ParrotSecurity"
...
# Crear el menú
  menu=(dialog --radiolist "Marca la versión del ParrotSecurity del contenedor y presiona Enter:" 22 70 16)
    opciones=(
      1 "Última versión testing"   off
      2 "Última versión inestable" off
      3 "Última versión estable"   on
      4 "ParrotSecurity 13 (Trixie)"       off
      5 "ParrotSecurity 12 (Bookworm)"     off
      6 "ParrotSecurity 11 (Bullseye)"     off
    )
  choices=$("${menu[@]}" "${opciones[@]}" 2>&1 >/dev/tty)
    ...
    do
      case $choice in
        ...
        1)
          ...
          echo ""
          vRelease='testing'
          read -p "    Introduce el hostname que quieras darle al contenedor. Por ejemplo SystemdSandboxParrotSecurityTesting: " vNombreDelContenedor
        ...
        2)
          ...
          echo ""
          vRelease='sid'
          read -p "    Introduce el hostname que quieras darle al contenedor. Por ejemplo SystemdSandboxParrotSecuritySid: " vNombreDelContenedor
        ...
        3)
          ...
          echo ""
          vRelease='stable'
          read -p "    Introduce el hostname que quieras darle al contenedor. Por ejemplo SystemdSandboxParrotSecurityStable: " vNombreDelContenedor
        ...
        4)
          ...
          echo ""
          echo "  ParrotSecurity 13 (Trixie)..."
          echo ""
          vRelease='trixie'
          read -p "    Introduce el hostname que quieras darle al contenedor. Por ejemplo SystemdSandboxParrotSecurityTrixie: " vNombreDelContenedor
        ...
        5)
          ...
          echo ""
          echo "  ParrotSecurity 12 (Bookworm)..."
          echo ""
          vRelease='bookworm'
          read -p "    Introduce el hostname que quieras darle al contenedor. Por ejemplo SystemdSandboxParrotSecurityBookworm: " vNombreDelContenedor
        ...
        6)
          ...
          echo ""
          echo "  ParrotSecurity 11 (Bullseye)..."
          echo ""
          vRelease='bullseye'
          read -p "    Introduce el hostname que quieras darle al contenedor. Por ejemplo SystemdSandboxParrotSecurityBullseye: " vNombreDelContenedor
...
# Nuevas variables
  vDirSandbox=""$vCarpetaBase"/ParrotSecurity-$vRelease-$cFechaDeEjec"

# Crear el sistema de archivos de ParrotSecurity
  ...
  # Sólo proceder si la carpeta no existe previamente
    if [ ! -d "$vDirSandbox" ]; then
      echo ""
      echo "  Creando sandbox/contenedor de systemd con ParrotSecurity "$vRelease" en $vDirSandbox..."
      echo ""
      sudo debootstrap --include="$vPaqMin" "$vRelease" "$vDirSandbox" "$vMirrorParrotSecurity"
    else
      echo ""
...
# Iniciar el sandbox con aislamiento y carpeta compartida
  ...
  echo ""
  echo "  Iniciando sandbox/contenedor de systemd con ParrotSecurity..."
  echo ""
